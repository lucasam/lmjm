  ...
  return (
    <div style={overlayStyle} onClick={onClose} role="presentation">
      <div style={modalStyle} onClick={(e) => e.stopPropagation()}>
        <h2 style={modalTitle}>{t('pigs.newFeedBalance')}</h2>
        ...
        <form onSubmit={handleSubmit}>
          <label style={labelStyle}>
            ...
            <input type="date" required value={measurementDate} onChange={(e) => setMeasurementDate(e.target.value)} style={inputStyle} />
          </label>

          <label style={labelStyle}>
            {t('pigs.balanceKg')} *
            <input type="number" required min="0" step="any" value={balanceKg} onChange={(e) => setBalanceKg(e.target.value)} style={inputStyle} />
          </label>
