...
def lambda_handler(event: dict[str, Any], context: Any) -> dict[str, Any]:
    ...
    if action_type == ProcedureActionType.weight:
        ...
        # Requirement 5.2: a diagnostic requires a prior insemination on the animal.
        if insemination_repo.get_latest(animal.pk) is None:
            return respond(status_code=404, error="No insemination record found for animal")
